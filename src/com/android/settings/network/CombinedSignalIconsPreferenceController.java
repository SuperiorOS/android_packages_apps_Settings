...
public class CombinedSignalIconsPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        int resourceId = Resources.getSystem().getIdentifier("flag_combined_status_bar_signal_icons","bool", "android");
        final boolean isPrefAllowedOnDevice = mContext.getResources().getBoolean(resourceId);
        return isPrefAllowedOnDevice;
    }
}

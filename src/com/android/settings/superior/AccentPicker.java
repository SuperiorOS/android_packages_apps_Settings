...
public class AccentPicker extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private void initView() {
        ...
        if (jadeGreenAccent != null) {
         ...
         Button qPurpleAccent = null;
        if (mView != null) {
            qPurpleAccent = mView.findViewById(R.id.qPurpleAccent);
        }
        if (qPurpleAccent != null) {
            qPurpleAccent.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Settings.System.putIntForUser(resolver,
        ...
        if (qGreenAccent != null) {
         ...
         Button oneplusred = null;
        if (mView != null) {
            oneplusred = mView.findViewById(R.id.oneplusred);
        }
        if (oneplusred != null) {
            oneplusred.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Settings.System.putIntForUser(resolver,
         ...
         Button pixel = null;
        if (mView != null) {
            pixel = mView.findViewById(R.id.pixel);
        }
        if (pixel != null) {
